...
int main (int narg, char** varg) {
    ...
    MultiCircuit greedy_multi_circ = to_multi_circuit(multi_network);
    std::cout << "#number of subcircuits: " << greedy_multi_circ.circuits.size() << "\n";
    printMultiCircuit(greedy_multi_circ,std::cout);
    print_communication_cost(greedy_multi_circ);
